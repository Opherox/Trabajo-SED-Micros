...
uint8_t registros_estados[2];
uint8_t audio_addr_read = 0x95;
uint8_t audio_addr_write = 0x94;
...
int main(void)
{
  ...
  //POWER CONTROL 1
  estado[0]=0x02;
  estado[1]=0x9E; //Power down 0x01 / 0x9E para encender
  ...
  while (1)
  {
	  HAL_I2S_Transmit(&hi2s3, (uint16_t *)audio, 1024 , HAL_MAX_DELAY);
